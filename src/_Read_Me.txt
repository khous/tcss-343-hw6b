...
the starter code was provided by the instructor Ka Yee Yeung which includes the interface Graph and the classes Vertex,
Edge, and Path.
...
In adjacentVertices, I iterated over the edges of any particular vertex to deturmine the cost of each near by node
instead of making a separate dijstra node (making nodes was an option other students took, but during my implementation,
 I didn't want to alter the instructors code for Vertex which led me to work with edges instead).
